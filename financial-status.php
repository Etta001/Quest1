...
<div class="main-content">
    ...
    <div class="page-header">
        <h1><i class="fas fa-coins"></i> Financial Status</h1>
        ...
        <div class="financial-card main-card">
            <div class="financial-header">
                ...
                <div class="status-badge <?php echo $status == 'paid' ? 'paid' : 'owing'; ?>">
                    <i class="fas <?php echo $status == 'paid' ? 'fa-circle-check' : 'fa-circle-exclamation'; ?>"></i>
                    <?php echo $status == 'paid' ? 'Paid' : 'Owing'; ?>
                </div>
            </div>
            ...
            <div class="financial-card side-card">
                ...
                <div class="payment-stats">
                    <div class="payment-stat">
                        <span class="stat-number paid-stat"><?php echo number_format($paid, 0, ',', ' '); ?></span>
                        <span class="stat-label">Paid</span>
                    </div>
                    <div class="payment-stat">
                        <span class="stat-number <?php echo $balance > 0 ? 'balance-due-stat' : 'balance-clear-stat'; ?>">
                            <?php echo number_format($balance, 0, ',', ' '); ?>
                        </span>
                        <span class="stat-label">Balance</span>
                    </div>
                    <div class="payment-stat">
                        <span class="stat-number progress-stat"><?php echo $percentage; ?>%</span>
