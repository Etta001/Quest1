...
$isNestedArea = strpos($_SERVER['PHP_SELF'] ?? '', '/lecturer/') !== false;
$basePath = $isNestedArea ? '../' : '';
?>
    ...
    <div class="sidebar-overlay-content">
        ...
        <div class="sidebar-profile">
            <div class="sidebar-avatar" id="sidebarAvatar">
                <?php
                $avatarPath = ltrim($currentUser['avatar'] ?? '', './');
                $avatarFile = __DIR__ . '/../' . $avatarPath;
                if ($avatarPath !== '' && file_exists($avatarFile)) {
                    echo '<img src="' . $basePath . htmlspecialchars($avatarPath) . '" alt="Profile" style="width:100%;height:100%;border-radius:50%;object-fit:cover;">';
                } else {
        ...
        <div class="nav-menu">
            ...
            <a href="<?php echo $basePath; ?>timetable.php" class="nav-item <?php echo $currentPage == 'timetable.php' ? 'active' : ''; ?>">
                <i class="fas fa-calendar-alt"></i> Timetable
            </a>
            <a href="<?php echo $basePath; ?>exam-dates.php" class="nav-item <?php echo $currentPage == 'exam-dates.php' ? 'active' : ''; ?>">
                <i class="fas fa-calendar-check"></i> Exam Dates
            </a>
            <a href="<?php echo $basePath; ?>calendar.php" class="nav-item <?php echo $currentPage == 'calendar.php' ? 'active' : ''; ?>">
                <i class="fas fa-calendar-week"></i> Calendar
            </a>
            <a href="<?php echo $basePath; ?>question-bank.php" class="nav-item <?php echo $currentPage == 'question-bank.php' ? 'active' : ''; ?>">
                <i class="fas fa-database"></i> Question Bank
            </a>
            <a href="<?php echo $basePath; ?>exam-results.php" class="nav-item <?php echo $currentPage == 'exam-results.php' ? 'active' : ''; ?>">
                <i class="fas fa-chart-line"></i> Exam Results
            </a>

            <!-- Resources -->
            <div class="nav-section">Resources</div>
            <a href="<?php echo $basePath; ?>news.php" class="nav-item <?php echo $currentPage == 'news.php' ? 'active' : ''; ?>">
                <i class="fas fa-newspaper"></i> News &amp; Updates
            </a>
            <a href="<?php echo $basePath; ?>library.php" class="nav-item <?php echo $currentPage == 'library.php' ? 'active' : ''; ?>">
            ...
            <a href="<?php echo $basePath; ?>financial-status.php" class="nav-item <?php echo $currentPage == 'financial-status.php' ? 'active' : ''; ?>">
            ...
            <div class="theme-switcher">
                <button class="theme-btn active" data-theme="light" onclick="setTheme('light')" title="Light theme" aria-label="Use light theme"><i class="fas fa-sun"></i></button>
                <button class="theme-btn" data-theme="dark" onclick="setTheme('dark')" title="Dark theme" aria-label="Use dark theme"><i class="fas fa-moon"></i></button>
                <button class="theme-btn" data-theme="navy" onclick="setTheme('navy')" title="Navy theme" aria-label="Use navy theme"><i class="fas fa-droplet"></i></button>
            </div>

            <!-- Logout -->
            <div class="logout-item">
                <a href="<?php echo $basePath; ?>logout.php" class="nav-item logout">
