...
<div class="admin-main-content">
    <div style="display: flex; justify-content: space-between; align-items: center; flex-wrap: wrap; gap: 16px; margin-bottom: 24px;">
        ...
        <div style="display: flex; gap: 12px;">
            ...
            <a href="manage-lecturers.php" class="btn-primary">
                ...
                <tbody>
                    ...
                    ?>
                        <tr>
                            ...
                            <td>
                                <?php if ($avatarExists): ?>
                                    <img src="<?php echo $avatarPath; ?>" alt="Avatar" class="user-avatar-image">
                                <?php else: ?>
                            ...
                            <td>
                                <span class="matricule-code">
                                    ••••••••
                                </span>
                                <a href="?resetpass=<?php echo $user['id']; ?>" class="reset-password-link" onclick="return confirm('Reset password to default (password123)?')">
                            ...
                            <td style="white-space: nowrap; min-width: 180px;">
                                ...
                                <?php else: ?>
                                    <span class="form-hint">Cannot modify self</span>
                                <?php endif; ?>
                            </td>
                        </tr>
                    <?php endforeach; ?>
