...
<div class="admin-main-content">
    <div style="display: flex; justify-content: space-between; align-items: center; flex-wrap: wrap; gap: 16px; margin-bottom: 24px;">
        ...
        <a href="manage-students.php" class="btn-primary btn-secondary">
    ...
    <div class="admin-card" style="max-width: 700px; margin: 0 auto;">
        <form method="POST">
            ...
            <div class="form-group">
                ...
                <input type="text" name="matricule" class="form-input" placeholder="e.g., CITEC-HITM/SWE/001" required>
                <small class="form-hint">This must be unique for each student.</small>
            </div>
