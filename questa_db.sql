...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 22, 2026 at 01:54 PM
...
(14, 'MATRICULATION', 'matriculation ceremony of HND students', '2026-06-15', 'academic', '2026-06-15 20:16:49');
...
CREATE TABLE `financial_records` (
  `id` int(11) NOT NULL,
  `student_id` int(11) NOT NULL,
  `total_fees` int(11) DEFAULT 350000,
  `paid` int(11) DEFAULT 0,
  `balance` int(11) DEFAULT 350000,
...
INSERT INTO `financial_records` (`id`, `student_id`, `total_fees`, `paid`, `balance`, `status`, `deadline`, `created_at`) VALUES
(1, 8, 350000, 150000, 200000, 'owing', '2025-06-30', '2026-06-22 08:45:08');
...
(4, 'CITEC-HITM Students Win National Coding Competition', 'Congratulations to our Software Engineering team who emerged first place at the Cameroon National Coding Challenge 2025! The team developed an innovative health-tech solution that impressed the judges. The competition saw participation from over 50 universities across Cameroon. This achievement brings great honor to CITEC-HITM and showcases the quality of our tech education.', 'Our Software Engineering team emerged first place at the Cameroon National Coding Challenge 2025.', 'achievement', 0, 'Dean\'s Office', 0, '2026-04-30 13:24:54'),
...
INSERT INTO `notifications` (`id`, `user_id`, `title`, `message`, `type`, `sent_at`, `is_read`) VALUES
(1, 2, 'SCHOOL FEES', 'Your deadline is tomorrow come and pay your fees', 'deadline', '2026-06-22 11:18:50', 0),
(2, 4, 'SCHOOL FEES', 'Your deadline is tomorrow come and pay your fees', 'deadline', '2026-06-22 11:18:50', 0),
(3, 5, 'SCHOOL FEES', 'Your deadline is tomorrow come and pay your fees', 'deadline', '2026-06-22 11:18:50', 0),
(4, 6, 'SCHOOL FEES', 'Your deadline is tomorrow come and pay your fees', 'deadline', '2026-06-22 11:18:50', 0),
(5, 8, 'SCHOOL FEES', 'Your deadline is tomorrow come and pay your fees', 'deadline', '2026-06-22 11:18:50', 1),
(6, 2, 'SCHOOL FEES', 'Your deadline is tomorrow come and pay your fees', 'deadline', '2026-06-22 11:33:00', 0),
(7, 4, 'SCHOOL FEES', 'Your deadline is tomorrow come and pay your fees', 'deadline', '2026-06-22 11:33:00', 0),
(8, 5, 'SCHOOL FEES', 'Your deadline is tomorrow come and pay your fees', 'deadline', '2026-06-22 11:33:00', 0),
(9, 6, 'SCHOOL FEES', 'Your deadline is tomorrow come and pay your fees', 'deadline', '2026-06-22 11:33:00', 0),
(10, 8, 'SCHOOL FEES', 'Your deadline is tomorrow come and pay your fees', 'deadline', '2026-06-22 11:33:00', 1),
(11, 2, 'SCHOOL FEES', 'Come and pay your school fees the day is due', 'deadline', '2026-06-22 11:33:35', 0),
(12, 4, 'SCHOOL FEES', 'Come and pay your school fees the day is due', 'deadline', '2026-06-22 11:33:35', 0),
(13, 5, 'SCHOOL FEES', 'Come and pay your school fees the day is due', 'deadline', '2026-06-22 11:33:35', 0),
(14, 6, 'SCHOOL FEES', 'Come and pay your school fees the day is due', 'deadline', '2026-06-22 11:33:35', 0),
(15, 8, 'SCHOOL FEES', 'Come and pay your school fees the day is due', 'deadline', '2026-06-22 11:33:35', 1),
(16, 2, 'SCHOOL FEES', 'Come and pay your school fees the day is due', 'fee', '2026-06-22 11:34:19', 0),
(17, 4, 'SCHOOL FEES', 'Come and pay your school fees the day is due', 'fee', '2026-06-22 11:34:19', 0),
(18, 5, 'SCHOOL FEES', 'Come and pay your school fees the day is due', 'fee', '2026-06-22 11:34:19', 0),
(19, 6, 'SCHOOL FEES', 'Come and pay your school fees the day is due', 'fee', '2026-06-22 11:34:19', 0),
(20, 8, 'SCHOOL FEES', 'Come and pay your school fees the day is due', 'fee', '2026-06-22 11:34:19', 1),
(21, 2, 'FEES', 'Come and pay your school fees the day is due', 'fee', '2026-06-22 11:34:38', 0),
(22, 4, 'FEES', 'Come and pay your school fees the day is due', 'fee', '2026-06-22 11:34:38', 0),
(23, 5, 'FEES', 'Come and pay your school fees the day is due', 'fee', '2026-06-22 11:34:38', 0),
(24, 6, 'FEES', 'Come and pay your school fees the day is due', 'fee', '2026-06-22 11:34:38', 0),
(25, 8, 'FEES', 'Come and pay your school fees the day is due', 'fee', '2026-06-22 11:34:38', 1),
(26, 2, 'SILAS NDI', 'A NEW PAPER IS UNDERWAY', 'upload', '2026-06-22 11:38:08', 0),
(27, 4, 'SILAS NDI', 'A NEW PAPER IS UNDERWAY', 'upload', '2026-06-22 11:38:08', 0),
(28, 5, 'SILAS NDI', 'A NEW PAPER IS UNDERWAY', 'upload', '2026-06-22 11:38:08', 0),
(29, 6, 'SILAS NDI', 'A NEW PAPER IS UNDERWAY', 'upload', '2026-06-22 11:38:08', 0),
(30, 8, 'SILAS NDI', 'A NEW PAPER IS UNDERWAY', 'upload', '2026-06-22 11:38:08', 1);
...
CREATE TABLE `payment_history` (
  ...
  `previous_paid` int(11) NOT NULL,
  `new_paid` int(11) NOT NULL,
...
INSERT INTO `payment_history` (`id`, `student_id`, `amount`, `type`, `previous_paid`, `new_paid`, `admin_id`, `created_at`) VALUES
(1, 8, 700000, 'reverse', 1403000, 703000, 1, '2026-06-22 11:14:12'),
(2, 8, 3000, 'reverse', 703000, 700000, 1, '2026-06-22 11:14:25'),
(3, 8, 300000, 'reverse', 700000, 400000, 1, '2026-06-22 11:15:37'),
(4, 8, 350000, 'reverse', 400000, 50000, 1, '2026-06-22 11:16:21'),
(5, 8, 50000, 'reverse', 50000, 0, 1, '2026-06-22 11:16:38'),
(6, 8, 150000, 'add', 0, 150000, 1, '2026-06-22 11:17:01');
...
(4, 'VIRTUAL REALITY', 1, '2025', '1', '../uploads/papers/1778852595_VIRTUAL_REALITY.pdf', NULL, 0, NULL, NULL, 1, '2026-05-15 14:43:15', 0),
(5, 'DIGITAL SIGNAL PROCESSING', 4, '2025', '2', '../uploads/papers/1781554713_DIGITAL_SIGNAL_PROCESSING.pdf', NULL, 0, NULL, NULL, 1, '2026-06-15 21:18:33', 0);
...
(2, 'Demo Student', 'demo@questa.com', '$2y$10$.yMolpdCJS8Xeq.Ym9F76.rh6hZTuXTzmPonBw/XNFyAJehuOUjE2', 'student', 'DEMO/2025/001', 1, NULL, '2026-04-30 11:55:44'),
...
(7, 'Silas Ndi', 'silas@questa.com', '$2y$10$tYOFChKzwsiqxBwcMqNmRuIZyTN/JLfJU.9qv.gjzeXd6CE7XLlP2', 'lecturer', NULL, 6, NULL, '2026-06-15 21:19:27'),
(8, 'NFORMI SILAS NDI', 'Ndinformisilas@questa.com', '$2y$10$G7Ar/JTut4UKAVpGEf8rBuj18HmGeUV0HctL/BQaTExVHzGWzJegm', 'student', 'HIPTEX/SWE/005', 1, 'uploads/avatars/1782118719_8.jpg', '2026-06-22 09:45:08'),
(9, 'Lesly Numvi', 'lesly@questa.com', '$2y$10$wdG9G.oGhvcHBb/dqV5NiuX3EbiFIcoqfWlSRjN2eS1UepmKFbdLi', 'lecturer', NULL, 6, NULL, '2026-06-22 10:34:21');
...
--
ALTER TABLE `financial_records`
  ADD CONSTRAINT `financial_records_ibfk_1` FOREIGN KEY (`student_id`) REFERENCES `users` (`id`) ON DELETE CASCADE;
...
--
ALTER TABLE `payment_history`
  ADD CONSTRAINT `payment_history_ibfk_1` FOREIGN KEY (`student_id`) REFERENCES `users` (`id`) ON DELETE CASCADE,
  ADD CONSTRAINT `payment_history_ibfk_2` FOREIGN KEY (`admin_id`) REFERENCES `users` (`id`) ON DELETE CASCADE;
